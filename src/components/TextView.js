...
const TextView = ({
  ...
  <div className="box-border mb-5 max-[767px]:mb-2 w-[60%] max-[767px]:w-full max-[767px]:h-[70vh] p-3 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
