...
const TextView = ({
  ...
  <div className="border-2 border-gray-200 w-[60%] p-6 border-dashed rounded-lg dark:border-gray-700">
    ...
    <div className="mb-6">
      <h5 class="text-xl font-bold dark:text-white">{ songName }</h5>
      <h6 class="text-lg font-bold dark:text-white">{ singerName }</h6>
    ...
    <div className="overflow-auto p-6 bg-white border border-gray-200 rounded-lg shadow h-[47vh]">
