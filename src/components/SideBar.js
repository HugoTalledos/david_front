    ...
    <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
      <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul className="space-y-2 font-medium">
          ...
          <li>
            <a href={'/create'} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li>
            <a href={`${REACT_APP_STRAPPI_URL}/admin/content-manager/collectionType/api::song.song?page=1&pageSize=10&sort=so_name:ASC&user=${sessionStorage.getItem("userInfo")}&token=${sessionStorage.getItem("jwtToken")}`} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li>
            <a href={`${REACT_APP_STRAPPI_URL}/admin/content-manager/collectionType/api::singer.singer?page=1&pageSize=10&sort=si_name:ASC&user=${sessionStorage.getItem("userInfo")}&token=${sessionStorage.getItem("jwtToken")}`} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">Crear cantante</span>
            </a>
          </li>
          <li>
