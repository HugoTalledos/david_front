...
const ViewSetMobile = ({ group, onClick, config}) => {
  ...
  return (<section id="mobile" className="flex flex-col justify-center gap-y-3 p-5 h-[95vh] box-content">
    <div id="drawer-navigation" className={`fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform ${ open ? 'transform-none' : '-translate-x-full'} bg-white dark:bg-gray-800`} tabindex="-1" aria-labelledby="drawer-navigation-label">
      <h5 id="drawer-navigation-label" className="text-base font-semibold text-gray-500 uppercase dark:text-gray-400">{ group.setName }</h5>
      <button type="button"
    ...
    </div>
    {
      ...
      : <>
            ...
            <div className='flex justify-between gap-3'>
              ...
              <div className='relative'>
                <button id="dropdownDefaultButton"
                        ...
                        className="h-3 border border-gray-200 text-gray focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                ...
                <div id="dropdown"
                    ...
                    className={`absolute z-4 ${openDrop ? '' : 'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
        ...
        <div className="flex content-center mt-auto gap-2">
          <button type="button"
